...
@Getter
public class BulkNotificationTaskEvent extends ApplicationEvent {
  ...
  public BulkNotificationTaskEvent(Object source, Set<Long> receiverIds,
  ...
  public BulkNotificationTaskEvent(Object source, BulkNotificationEvent event) {
    super(source);
    this.receiverIds = event.getReceiverIds();
